...
namespace Irc4
{
    ...
    internal class Server : ServerInfo, ISec
    {
        ...
        internal bool IsDisconnectedExpected { get; private set; }
        /// <summary>
        /// 
        /// </summary>
        public async Task Connect()
        {
            ...
            try
            {
                ...
                await socketStream.ConnectAsync(hostname, this.Port);
            }
            ...
            try
            {
                await socketStream.ReceiveAsync();
            }
            catch (SocketException ex)
            {
                string message = "";
        ...
        public async Task<bool> SendCmd(string str)
        {
            ...
            try
            {
                await socketStream.SendAsync(s);
                b = true;
            }
            catch (SocketException ex)
            {
        ...
        internal async Task ForceDisconnect()
        {
            ...
            try
            {
                await socketStream.DisconnectAsync();
            }
            catch (SocketException ex)
            {
                string message = "";
